...
const dict = {
  ...
  chooseGrade: { en: 'Choose grade', bn: 'গ্রেড বাছুন' },
  ...
  farmToDoor: { en: 'Farm to door', bn: 'খামার থেকে সোজা ঘরে' },
  ...
  utrLabel: { en: 'PhonePe / UPI Name', bn: 'UPI প্রেরকের নাম' },
  ...
  verified: { en: 'verified', bn: 'যাচাই সম্পন্ন' },
  pending: { en: 'pending', bn: 'অপেক্ষমাণ' },
  howToPay: {
    en: '1) Tap PhonePe / GPay or scan QR → 2) Send payment → 3) Tap "I Have Paid"',
    bn: '১) PhonePe / GPay ট্যাপ করুন বা QR স্ক্যান করুন → ২) টাকা পাঠান → ৩) "পেমেন্ট করেছি" বাটনে ক্লিক করুন',
  },
  tipMin: {
    en: 'Tip: Add items until cart reaches ₹500 minimum.',
    bn: 'টিপ: অর্ডারের জন্য কার্টে কমপক্ষে ₹৫০০ মূল্যের পণ্য যোগ করুন।',
  },
  ...
  far: { en: 'Far', bn: 'দূরবর্তী' },
  standard: { en: 'Standard', bn: 'সাধারণ' },
  zone: { en: 'Zone', bn: 'জোন' },
  fee: { en: 'Fee', bn: 'ফি' },
  backDashboard: { en: '← Dashboard', bn: '← ড্যাশবোর্ড' },
  menu: { en: 'Menu', bn: 'মেনু' },
  orderPlaced: { en: 'Order placed!', bn: 'অর্ডার সফলভাবে সম্পন্ন হয়েছে!' },
  orderNotFound: { en: 'Order not found', bn: 'অর্ডার পাওয়া যায়নি' },
  viewMyOrders: { en: 'View my orders', bn: 'আমার সমস্ত অর্ডার দেখুন' },
  keepShopping: { en: 'Keep shopping', bn: 'আরও কেনাকাটা করুন' },
